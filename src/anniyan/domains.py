...
domain_map: dict[str, set[str]] = dict()
application: set[str] = {
...
domain_map["application"] = application
audio: set[str] = {
	"1d-interleaved-parityfec",
	"32kadpcm",
	"3gpp",
...
domain_map["font"] = font
haptics: set[str] = {
	"ivs",
	"hjif",
	"hmpg"
}
domain_map["haptics"] = haptics
image: set[str] = {
	"aces",
	"apng",
	"avci",
...
domain_map["multipart"] = multipart
text: set[str] = {
	"1d-interleaved-parityfec",
	"cache-manifest",
	"calendar",
